                ...
                <div class="card-body">
                    ...
                    <form action="/dashboard/admin" method="post">
                        ...
                        <div class="form-group has-success">
                            ...
                            <input id="cc-name" value="{{ old('fullname') }}" name="fullname" type="text"
                            ...
                            <table class="table table-borderless table-data3">
                                ...
                                @foreach($admins as $admin)
                                    <tr>
                                        ...
                                        <td>{{$admin->email}}</td>
                                        <td><a class="text-primary" href="/dashboard/admin/{{$admin->id}}/edit"><span
                                                    class="btn btn-primary">edit</span></a></td>
                                        <td class="text-primary"><a class="text-danger"
                                                                    href="/dashboard/admin/{{$admin->id}}"><span
