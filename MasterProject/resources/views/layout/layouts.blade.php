...
{{--                    <button type="button" class="btn btn-danger" style="width: 100%;height: 100%">{{ __('Logout') }}</button>--}}
Logout
                ...
                <ul>
                    ...
                    <li>
                        <div class="wrapper for-close">
                            <a href="#" class="wrapper-img"> <img src="{{asset("uploads/images/$product[image]")}}" style="max-height: 90px;" alt="1"/> </a>
    ...
    <div class="footer">
        <div class="rq-container">
            <div class="item1">
                ...
                <p>This website built to make shopping the dress easier and the girl wear a unique
                    dress for her event. It is a website to make the shopping easier to the user and provide them with
                    latest dresses on fashion field.</p>
                <div class="get-touch">
